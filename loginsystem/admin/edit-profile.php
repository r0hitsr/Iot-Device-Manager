...
if (strlen($_SESSION['adminid'] == 0)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $userid = $_GET['uid'];
        $msg = mysqli_query($con, "update users set fname='$fname',cname='$cname',company_id='$company_id',contactno='$contact' where id='$userid'");
                                ...
                                <form method="post">
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <th>Company Id</th>
                                                <td><input class="form-control" id="company_id" name="company_id" type="text" value="<?php echo $result['company_id']; ?>" required /></td>
                                            </tr>
                                            <tr>
                                                <th>Contact No.</th>
