...
if (isset($_POST['submit'])) {
    ...
    if ($row > 0) {
        ...
        $msg = mysqli_query($con, "insert into users(fname,cname,email,company_id,password,contactno) values('$fname','$cname','$email','$company_id','$password','$contact')");
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h2 align="center">ERAM Solutions Signup System</h2>
                                    <hr />
                                ...
                                <div class="card-body">
                                    <form method="post" name="signup" onsubmit="return checkpass();">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="cname" name="cname" type="text" placeholder="Enter your Company name" required />
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="company_id" name="company_id" type="company_id" placeholder="CREAM000" required />
